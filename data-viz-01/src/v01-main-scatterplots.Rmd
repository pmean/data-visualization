...
ggplot(marital_status, aes(x=class, y=prop)) +
  geom_col() +
  geom_segment(
    x=1.5, y=19.6, xend=2.5, yend=19.6, 
...
![Bar chart, projecting one bar to another](../images/bar-chart-3.png)
...
ggplot(marital_status, aes(x="", y=prop, fill=class)) +
  geom_col() +
  geom_segment(
    x=1.3, xend=1.3, y=80.4, yend=100, 
    size=2, color="darkred",
    arrow=arrow(ends="both")) +
  geom_segment(
    x=1.3, xend=1.3, y=8.8, yend=30.8, 
    size=2, color="darkred",
    arrow=arrow(ends="both"))
```
...
ggplot(marital_status, aes(x = "", y = prop, fill = class)) +
  ...
  theme_void() +
  geom_segment(
    x=1, xend=1, y=80.4, yend=100, 
    size=2, color="red",
    arrow=arrow(ends="both")) +
  geom_segment(
    x=1, xend=1, y=8.8, yend=30.8,
    size=2, color="darkred",
    arrow=arrow(ends="both"))
```

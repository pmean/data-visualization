---
title: "Data-viz-01, Tutorial, Evaluating visualizations"
author: "Steve Simon"
...
![Bar chart, with four bars side by side](../images\r\`r fn`.png)
...
![Bar chart, four bars stacked in a single column](../images\r\`r fn`.png)
...
![Bar chart, projecting one bar to another](../images\r\`r fn`.png)
...
![Stacked bar chart, comparing lengths](../images\r\`r fn`.png)
...
![Pie chart, comparing two angles](../images\r\`r fn`.png)
...
![Pie chart, estimating a percentage for one wedge](../images\r\`r fn`.png)
...
### Evaluation, For a percentage question, the stacked bar chart is second best
...
![Stacked bar chart, estimating percentage](../images\r\`r fn`.png)
...
### Evaluation, The side-by-side bar chart is hopeless for percentage questions.
...
![Bar chart, trying to assess percentage questions](../images\r\`r fn`.png)
...
### Evaluation, Improvements to the "hopeless" bar chart
...
![Bar chart, with bars re-ordered and a percentage value on the Y axis](../images\r\`r fn`.png)

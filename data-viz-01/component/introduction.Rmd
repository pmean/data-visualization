...
This workshop is split up into five modules that cover scatterplats, bar charts, line plots, surface plots, and maps.
...
Each module will start with some basic preparations that you need.

Then you will review some data visualizations that appeats in newpspaper or web articles. Your goal is to identify in 25 words or less what the message is that the visualization is trying to convey.
...
You will return to the newspaper articles and identify features of the data visualizations used.

You will have to answer a short quiz, not for a grade, but to reinforce some of the important points in the module. 

Then you will work on your own with a different data set, trying to create effective data visualizations similar to the ones presented in this module.

...
finalize_image <- function() {
  fn <- opts_current$get("label")
  quiet <- dev.off()
  write(pd_text, file=paste0("../images/external", fn, ".txt"))
}
```
...
### Preparation, Choose "Saratoga House Prices" (not "Saratoga Houses")
...
### Preparation, What your scatterplot should look like (R version)
...
![Basic scatterplot](../images/r/`r fn`.png)


### Preparation, Importing into Tableau

...
Tableau will try to guess what type of marks to use, but if it guesses wrong, you can correct things with the Marks pull down menu. This menu gives you options for (among other things) Bar, Line, Shape (scatterplot), and Text.
...
These ideas are implemented in R (ggplot2), Python (Altair), and Tableau.

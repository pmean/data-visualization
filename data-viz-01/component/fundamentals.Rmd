...
Pat yourself on the back because you've alredy learned a lot. You know how to assign variables to the x and y positions of a graph. You can change the appears of the points on that graph. You can include a third variable in your graph, represented by shape, size, or color.

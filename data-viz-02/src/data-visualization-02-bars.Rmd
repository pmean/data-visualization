...
```{r rgb}
df <- data.frame(x=c(0, 0, 2, 2, 1, 1, 3, 3), y=c(0, 2, 2, 0, 1, 3, 3, 1))
df <- data.frame(x=1, y=1)
ggplot(df, aes(x, y)) + 
  geom_point() + 
  geom_segment(x=1, y=1, xend=3, yend=1) +
  geom_segment(x=1, y=1, xend=0, yend=0) +
  geom_segment(x=1, y=1, xend=1, yend=3) +

...
```{r rgb}
df <- data.frame(x=c(0.5, 0.5, 3, 3, 2, 2, 4, 4), y=c(0.5, 3, 3, 0.5, 2, 4, 4, 2))
df <- data.frame(x=2, y=2)
ggplot(df, aes(x, y)) + 
  geom_point() + 
  geom_segment(x=2, y=2, xend=4, yend=2) +
  geom_segment(x=2, y=2, xend=0.5, yend=0.5) +
  geom_segment(x=2, y=2, xend=2, yend=4) +
  geom_text(x=0.2, y=0.2, col=rgb(1, 0, 0), label="red", angle=45) +
  geom_text(x=4.2, y=2, col=rgb(0, 1, 0), label="green") + 
  geom_text(x=2, y=4.2, col=rgb(0, 0, 1), label="blue", angle=90) +

...
### Barchart fundamentals, Stack, Dodge, Normalize
...
### Barchart fundamentals, Python output for stacked bars
```{python}
import pandas as pd
import altair as alt
df = pd.read_csv("../../common-files/data/titanic3.csv")
...
### Barchart fundamentals, R output for stacked bars
...
### Barchart fundamentals, Tableau output for stacked bars
...
### Barchart fundamentals, code for dodge
+ Python code
```
ch = alt.Chart(df).mark_bar().encode(
    x='sex',
...
### Barchart fundamentals, Python output for dodged bars
...
### Barchart fundamentals, R output for dodged bars
...
+ Drag sex to columns (to the right of pclass)
  + Set to Dimension Discrete
+ Drag sex to colur button
  + Set to Dimension Discrete

</div>

### Barchart fundamentals, Code for normalize
+ Python code
```
ch = alt.Chart(df).mark_bar().encode(
    x='sex',
...
### Barchart fundamentals, R output for normalized bars
...
### Barchart fundamentals, Tableau output for normalized bars
...
All of the examples, so far, have used counts in the bar chart. There are many other statistics that you can choose from, and the trickiest, surprisingly, is percentage.

</div>

### Barchar fundamentals, Python output
...
### Barchart fundamentals, R output
...
ggplot(titanic, aes(survived)) +
  geom_bar(aes(fill=sex), position="fill")
finalize_image("Barchart of percentage survived")
```

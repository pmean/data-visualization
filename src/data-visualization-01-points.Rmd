...
![Main page of DASL website](../images/01/dasl-main-page.png)
...
![Description of the Saratoga house prices dataset](../images/01/dasl-saratoga-house-prices.png)
...
![Scatterplot of Arctic ice levels](../images/01/arctic-ice-scatterplot.png)

<div class="notes">

This is one of four graphs. It was published in
...
![Front cover of the book, The Grammar of Graphics](../images/01/the-grammar-of-graphics.png)
...
![Excerpt from the R help file for the barplot function](../images/01/r-barplot-help.png)
...
![Excerpt from the R help file for the hist function](../images/01/r-hist-help.png)
...
![Excerpt from the R help file for the boxplot function](../images/01/r-boxplot-help.png)
...
![Title slide from the Bergen-Iverson presentation](../images/01/bergen-2019.png)
